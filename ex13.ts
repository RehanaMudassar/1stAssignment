...
let favtrans = ["corolla car","vissle car", "Alto car"]
//console.log('i would like to own ', favtrans[1]);
//console.log('i would like to own ', favtrans[2]);
for (let i=0; i<=favtrans.length;i++)
{
    console.log('i would like to own', favtrans[i]);
}
